          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-50 rounded-2xl p-8">
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/company/investallyindia/" target="_blank" rel="noopener noreferrer" className="bg-teal-100 p-4 rounded-xl text-teal-600 hover:bg-teal-200 transition-colors duration-300" aria-label="LinkedIn">
